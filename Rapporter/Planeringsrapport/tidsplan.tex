...
\begin{center}
    ...
    \begin{tabular}{|c|c|c|}
      ...
      \hline
       ...
       \hline
       20 &  Tid för eventuell feedback &  Engelsk titel och sammanställd slutrapport och filminlämning\\
       \hline
      ...
      \hline
    \end{tabular}
    %\caption{Plan med delmål och deadlines för varje kalendervecka}
    %\label{tab:my_label}
    %\end{table}
    }
  \end{center}