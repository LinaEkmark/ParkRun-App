...
export default function SandboxScreen({ navigation }) {
  return (
    <View style={{ flex: 1,backgroundColor: 'white' ,alignItems: "center", justifyContent: "center" }}>
      ...
      <View>
        <CheckBox text="Check 1 - Ant hill" modalHeaderText= "123456789101112134" />
        <CheckBox text="Check 2 - Old tree" modalHeaderText= "Det gamla trädet" />
        ...
        <CheckBox text="Check 6 - Large rock" modalHeaderText= "2" />
